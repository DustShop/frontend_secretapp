  ...
  return (
    <div className="flex flex-row items-center gap-4">
      ...
      <div className="md:hidden relative flex items-center">
        <div className="cursor-pointer hover:rounded-full hover:shadow-lg transition duration-300 flex flex-row justify-between items-center gap-2 border border-gray-300 rounded-full p-2">
